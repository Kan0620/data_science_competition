...
def fitter(k=int(),n_fold=int(),param=float()):
    ...
    train_x[index100]=train_x[index100]*param
    test_x[index100]=test_x[index100]*param
    ...
    train_x['acousticness']=train_x['acousticness']*1
    test_x['acousticness']=test_x['acousticness']*1
