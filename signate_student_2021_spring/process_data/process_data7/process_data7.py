...
instrumentalness    2.891089 +log
    ...
    *np.exp(-all_data['loudness']/10)
    ...
    norm_list=['duration_ms','acousticness','positiveness','loudness',
    ...
    rank_norm_list=['popularity']
    
    for rank_norm_index in rank_norm_list:
        
    
        all_data[rank_norm_index]=rankdata(all_data[rank_norm_index],method='average')
    ...
    train.to_csv('processed_train7.csv')
    test.to_csv('processed_test7.csv')
